...
const DetailsSection = () => {
    ...
    const handleAddToCart = () => {
        if(user) {
            ...
            alert(`El libro ${bookData.book_name} se agregó a su carrito`);
        } else {
            navigate('/login');
            ...
            <div className='container'>
                <div className="flex-container">
                    ...
                    <div className='book-detail-container'>
                        ...
                        <p><b>Numero de páginas</b> : {bookData.print_length}</p>

                        <h3>&#36;{bookData.price}</h3>

                        <a onClick={handleAddToCart} className="button-primary">Agrega al carrito</a>
                    </div>
                </div>
            </div>
        </section>
